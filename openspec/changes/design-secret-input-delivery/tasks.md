...
- [x] 1.1 Define the secret input trust and redaction boundary.
- [x] 1.2 Define the operator input source shape and validation behavior.
- [x] 1.3 Define provider delivery and diagnostics behavior.
